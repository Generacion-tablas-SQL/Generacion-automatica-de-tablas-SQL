...
def main():
    create_table = "CREATE TABLE Persona (" \
                   ...
                   "string VARCHAR(15) NOT NULL CHECK (string LIKE 'C%' and LENGTH(string) > 5 and LENGTH(string) < 10)," \
                   "fec1 DATE NOT NULL, " \
    ...
    select4 = "SELECT string FROM Persona WHERE LENGTH(string) > 2 and LENGTH(string) < 20"
